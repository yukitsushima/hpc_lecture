...
std::vector<std::vector<double>> build_up_b(double rho,double dt,std::vector<std::vector<double>> u,std::vector<std::vector<double>> v,double dx,double dy,int nx,int ny){
